...
def go_dag(data_filepath, result_filepath='./result', seed=100, boost_path='/home/zhiyuan/Downloads/boost_1_68_0'):
	os.system("cd codes; g++ -I {} main.cpp generate_data.cpp io.cpp tests.cpp utils.cpp -o GO_DAG -std=c++11; cd -".format(boost_path))
	os.system("./codes/GO_DAG {} {} {}".format(data_filepath, result_filepath, seed))
